...
export default function WorldMap({
  ...
  const dottedMapInstance = useMemo(
  ...
  const svgMap = useMemo(() => {
    ...
    return dottedMapInstance.getSVG({
      radius: 0.22,
      color: isDark ? "#FFFFFF40" : "#00000040",
      shape: "circle",
      backgroundColor: isDark ? "black" : "white",
    });
  }, [dottedMapInstance, resolvedTheme]);
  ...
  return (
    <div className="relative aspect-[2/1] w-full rounded-lg bg-white font-sans dark:bg-black">
      ...
      >
        <title>Animated routes between studio locations</title>
        <defs>
          <linearGradient
            id={`path-gradient-${gradientId}`}
            x1="0%"
            y1="0%"
            x2="100%"
            y2="0%"
